...
BANCADA = [
    ...
    (690.00, "C31 TOCO dentro de tubo que passa direto"),
    (720.00, "C32 SOBREPOSICAO parcial quase total (90%)"),
    (745.00, "C33 SOBREPOSICAO parcial de 62% - NAO remove"),
    (770.00, "C34 CONEXOES duplicadas no mesmo ponto"),
    (795.00, "C35 CANTO - pontas a 90 graus que nao se cruzam"),
    (825.00, "C36 FALTA O TUBO entre tubo e conexao"),
    (855.00, "C37 TOCO para a conexao virar ramal"),
    (885.00, "C38 CONTROLE - tubos distantes, nada a fazer"),
    (915.00, "C39 APARAR tubo que atravessa o te"),
    (945.00, "C40 NAO MOVER conexao ja ligada e fora do eixo"),
    (975.00, "C41 CONJUNTO ligado sobre tubo que passa"),
]
...
def registrar(doc, elements, resultado, escolhas=None, resumo="",
    ...
    try:
        ...
        dados = {
            ...
            'duplicados_removidos': _limpar(resultado.get('redundantes') or []),
