...
Compatible with Revit 2024+ API (tested on 2026)

CHANGELOG v2.1:
- ✅ Corrigido get_element_id_value() para compatibilidade Revit 2026
- ✅ Removido uso de hasattr() com IntegerValue
- ✅ Otimizada performance com try/except
"""
...
class DataManager(object):
    ...
    def FindAndReplace(self, find_text, replace_text, column_name=None, use_regex=False, case_sensitive=False):
        """Find and replace in data with column-specific search
        
        Args:
            find_text (str): Text to find
            replace_text (str): Text to replace with
            column_name (str): Specific column name, or None for all columns
